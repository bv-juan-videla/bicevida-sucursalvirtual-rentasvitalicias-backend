...
import cl.bicevida.rentasvitalicias.dao.mapper.CreditoDisponibleMapper;
...
@Log4j
@Repository
public class CreditoDisponibleDAOImpl implements CreditoDisponibleDAO{
	...
	public CreditoDisponibleDAOImpl(){
		super();
	}
	...
	@Override
	public CreditoDisponibleDTO obtenerDatosCreditoDisponible(String rut) {
		
		//log.info("obtenerDatosCliente");
		System.out.println("CreditoDisponibleDTO obtenerDatosCreditoDisponible");
		
		List<CreditoDisponibleDTO> resultList = null;
		CreditoDisponibleDTO response = null;
		String sql = "PKG_SUCURSAL_VIRTUAL_CRE.CUPO_UTIL_DISPON_PREAPROB";
        //int vestado = 0;
        //int vnumcuenta = 0;
        //String vglosa= " ";
		...
		try{
			...
			.declareParameters(
				...
				new SqlOutParameter("result", OracleTypes.CURSOR, new CreditoDisponibleMapper()));
			MapSqlParameterSource mapSqlParameterSource = new MapSqlParameterSource();
			mapSqlParameterSource.addValue("vrut", rut);

			System.out.println("Carga de PKG");
			//executionTime.startLogin("CreditoDisponibleDAO.obtenerDatosCreditoDisponible");
			...
			//executionTime.stopLogin("CreditoDisponibleDAO.obtenerDatosCreditoDisponible");
			System.out.println("Paso de PKG");
			
			resultList = (List<CreditoDisponibleDTO>) result.get("result");
			...
			System.out.println("obtenerDatosCreditoDisponible: The result query is empty");
		}
		return response;
	}
